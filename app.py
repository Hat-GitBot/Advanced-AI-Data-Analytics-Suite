...
st.set_page_config(page_title="Universal Data Analytics", page_icon="📊", layout="wide")
...
def main():
    st.markdown('<h1 class="main-header">📊 Universal Data Analytics Platform</h1>', unsafe_allow_html=True)
